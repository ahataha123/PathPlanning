...
public class Canvas extends JComponent {
	...
	private final static Color LINE_COLOR           = new Color(100, 100, 200); // Darker blue
	private final static Color START_NODE_COLOR     = new Color(255, 128, 0);   // Orange
	private final static Color END_NODE_COLOR       = new Color(0, 200, 200);   // Cyan
	private final static Color DISABLED_NODE_COLOR  = new Color(105, 105, 105); // Dim gray
	private final static Color VISITED_NODE_COLOR   = new Color(200, 100, 150); // A shade of pink
	private final static Color SELECTED_NODE_COLOR  = new Color(0, 100, 0);     // Dark green
