	...
	public void demo() {
		...
		PropertyChangeListener propertyListener = new PropertyChangeListener() {
			...
			String format(XMatrix matrix) {
				...
				sb.append(", Time: ");
				sb.append(measureCountVisitedNodesTime(matrix));
				return sb.toString();
			}
			...
			long measureCountVisitedNodesTime(XMatrix matrix) {
				...
				System.out.println("Time taken by countVisitedNodes function: " + duration + " nanoseconds");
